!(function (t, e) {
	...
	var Nt = (function (n) {
		...
		return (
			...
			(e.previousLabel = function previousLabel(t) {
				return (
					void 0 === t && (t = this._time), ib(this, yt(this, t), 1)
				);
			}),
	...
	function Sb(t, e, r, i, n, a) {
		...
		if (
			...
			((r._pt = h =
				new ne(r._pt, n, t, 0, 1, u.render, u, 0, u.priority)),
			r !== d)
		)
			for (
			...
			return (
				...
				m !== Qe &&
					...
					r.svg &&
						...
						(r.forceCSS =
							t.setAttribute("transform", "") || !Id(od(t, qe))),
